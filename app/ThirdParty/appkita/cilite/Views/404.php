...
<html>
  <head>
    ...
    <title>404</title>
  <script defer="defer" src="<?= base_url('assets-admin/main.js') ?>"></script>
  <link href="<?= base_url('assets-admin/style.css') ?>" rel="stylesheet"></head>
  <body class="app">
    <div class="pos-a t-0 l-0 bgc-white w-100 h-100 d-f fxd-r fxw-w ai-c jc-c pos-r p-30">
      <div class="mR-60">
        <img alt="#" src="<?= site_url('assets-admin/images/404.png') ?>">
      </div>
      ...
      <div class="d-f jc-c fxd-c">
        ...
        <div>
          <a href="<?= base_url() ?>" type="primary" class="btn btn-primary">Go to Home</a>
        </div>
      </div>
    </div>
  </body>
